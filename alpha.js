...
const daftar1 = `*Hai Kak ${tampilUcapan}* 👋\n*Silakan Verify Dulu Yaa🥰*`
...
⬡ ${z}waktu jam : ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}${z}
...
{buttonId:`medsos`, buttonText: {displayText: 'MEDSOS OWNER👤'}, type: 1}
]
const menuu = {
    contentText: `${tod}`,
    footerText: `${tod2}`,
...
case 'medsos':
reply (`┏━━━━━━━━━━━━━━━━━━━━
⬡ *YT :* https://Youtube.com/fahrihmm
⬡ *IG :* https://instagram.com/@fahriodir_
⬡ *TT :* https://tiktok.com/@fahrihmmXD123
┗━━━━━━━━━━━━━━━━━━
jgn lupa follow yee `)
break
case 'funmenu':
...
case 'nsloli':
           ...
           sticWait(from)
           bo = args.join(' ')
           neko = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/neko?apikey=${lolkey}`)
           ...
           sticWait(from)
           bo = args.join(' ')
           lomli = await getBuffer(`https://api.lolhuman.xyz/api/random/art?apikey=KurrXd`)
           await alpha.sendMessage(from, lomlik, image, { quoted:mek,caption:'Lomli Ngab, awas ada FBI🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break 
           ...
           await alpha.sendMessage(from, hentai, image, { quoted:mek,caption:'Hentaii Nih, jgn lupa tobat yee🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break 
           ...
           await alpha.sendMessage(from, cecan, image, { quoted:mek,caption:'Nih Ngab Ceweknya lu mau kan🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break
